...
```bash
/Users/paolo/.claude/skills/morning-briefing/scripts/linear_fetch.py me
```
...
/Users/paolo/.claude/skills/morning-briefing/scripts/linear_fetch.py active

# Get 100 active issues
/Users/paolo/.claude/skills/morning-briefing/scripts/linear_fetch.py active 100
```
...
/Users/paolo/.claude/skills/morning-briefing/scripts/linear_fetch.py updated_today

# Limit to 25 issues
/Users/paolo/.claude/skills/morning-briefing/scripts/linear_fetch.py updated_today 25
```
...
/Users/paolo/.claude/skills/morning-briefing/scripts/linear_fetch.py completed_this_week

# Limit to 30 issues
/Users/paolo/.claude/skills/morning-briefing/scripts/linear_fetch.py completed_this_week 30
```
...
/Users/paolo/.claude/skills/morning-briefing/scripts/linear_fetch.py team JET

# Get 75 issues from team "TOT" (Totoro)
/Users/paolo/.claude/skills/morning-briefing/scripts/linear_fetch.py team TOT 75
```
...
result = subprocess.run(
    ['/Users/paolo/.claude/skills/morning-briefing/scripts/linear_fetch.py', 'active', '50'],
    capture_output=True,
    text=True
)
...
result = subprocess.run(
    ['/Users/paolo/.claude/skills/morning-briefing/scripts/linear_fetch.py', 'updated_today', '50'],
    capture_output=True,
    text=True
)
...
result = subprocess.run(
    ['/Users/paolo/.claude/skills/morning-briefing/scripts/linear_fetch.py', 'completed_this_week', '100'],
    capture_output=True,
    text=True
)
